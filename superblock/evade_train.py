...
# Backward-compatible alias for callers that reference the non-underscored helper name.
def resolve_motion_checkpoint_path(path: str) -> str:
    return _resolve_motion_checkpoint_path(path)
